...
//		public static readonly Rectangle PENGUIN_LARGE_PAPERBACK = new RectangleReadOnly(365, 561);
	...
	public class Rectangle
	{
		...
		{
			(this.X, this.Y, this.Width, this.Height, this.Rotation) = (X, Y, Width, Height, Rotation);
		}

		public Rectangle(float Width, float Height, float Rotation = 0)
		{
			(this.X, this.Y, this.Width, this.Height, this.Rotation) = (0, 0, Width, Height, Rotation);
		}
	}

	public class RectangleReadOnly : Rectangle
	{
		public RectangleReadOnly(float Width, float Height, float Rotation = 0)
			: base(Width, Height, Rotation) { }
	}
}
